...
SECRET_KEY = 'django-insecure-y^!b(q=yr+$jcvh(4$-$3#w)3x0@k31+tqn82xe0u#-5xb&(&3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['nikita-service.azurewebsites.net']
...
EMAIL_POST = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'python.vornik@gmail.com'
# el. pašto adresas iš kurio siųsite
EMAIL_HOST_PASSWORD = 'dwemlsghhptnyvfw'
# slaptažodis
